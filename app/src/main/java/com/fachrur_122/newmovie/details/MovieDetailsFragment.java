...
import com.fachrur_122.newmovie.utility.RxUtility;
...
public class MovieDetailsFragment extends Fragment implements MovieDetailsView, View.OnClickListener {
    ...
    public static MovieDetailsFragment getInstance(@NonNull Movie movie) {
        ...
        args.putParcelable(Const.MOVIE, movie);
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        if (getArguments() != null) {
            Movie movie = (Movie) getArguments().get(Const.MOVIE);
            if (movie != null) {
                mMovie = movie;
    ...
    public void showFavorited() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            mFavorite.setImageDrawable(getContext().getResources()
                    .getDrawable(R.drawable.ic_favorite_white_24dp,
                            getContext().getTheme()));
        } else { mFavorite.setImageDrawable(getContext().getResources().getDrawable(R.drawable.ic_favorite_white_24dp)); }
    }
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            mFavorite.setImageDrawable(getContext().getResources()
                    .getDrawable(R.drawable.ic_favorite_border_white_24dp,
                            getContext().getTheme()));
        } else { mFavorite.setImageDrawable(getContext().getResources().getDrawable(R.drawable.ic_favorite_border_white_24dp)); }
    }
    ...
    private void onFavoriteClick() { mMovieDetailsPresenter.onFavoriteClick(mMovie); }

    @Override
    public void onDestroyView() {
        RxUtility.unsubscribe(mTrailersSub);
        super.onDestroyView();
    }
